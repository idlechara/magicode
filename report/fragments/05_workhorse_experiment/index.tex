...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        % \includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_noise_redundant_bias.png.1_1.png}
        % \includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_noise_redundant_bias.png.1_2.png}
        \caption{IIQS}
        \label{FIG:WORKHORSE_BENCHMARK_05__0_0}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_noise_redundant_bias.png.0_1.png}
        \caption{bIIQS}
        \label{FIG:WORKHORSE_BENCHMARK_05__0_1}
    \end{subfigure}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        % \includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_redundant_bias.png.1_1.png}
        % \includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_redundant_bias.png.1_2.png}
        \caption{IIQS}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_redundant_bias.png.0_1.png}
        \caption{bIIQS}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        % \includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_noise_bias.png.1_1.png}
        % \includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_noise_bias.png.1_2.png}
        \caption{IIQS}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\includegraphics[width=0.40\textwidth]{./fragments/05_workhorse_experiment/images/01_basebenchmark_06_noise_bias.png.0_1.png}
        \caption{bIIQS}
