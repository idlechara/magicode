...
int main(int argc, char const *argv[])
{
    ...
    options.add_options()
        ...
        ("set-bfprt-beta",      boost::program_options::value<double>(&(configuration_ptr)->beta_value)->default_value(0.7f),               "set bfprt beta value")
        ...
        ("set-redundant-bias",  boost::program_options::value<double>(&(configuration_ptr)->redundant_bias)->default_value(0.5),             "set redundant selection bias, 0.0= left, 1.0=right, 0.5=center")
